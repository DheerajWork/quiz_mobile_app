...
class AnswerCont extends StatelessWidget {
  ...
  const AnswerCont({Key? key, this.answer, this.color, this.onTap, this.borderClr, this.shadow, this.fontClr}) : super(key: key);
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(answer!,style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,color: fontClr),),
                    Container(
                      decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          border: Border.all(
